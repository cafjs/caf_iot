...
exports.newInstance = function($, spec, cb) {
    try {
         ...
         *
         * @param {Error} error An error raised by the last processed command.
         * @param {caf.cb} cb0 A callback that will propagate the error if it
        ...
        that.__ca_pulse__= function(cb0) {
            ...
            var __iot_loop__ = that['__iot_loop__'];
