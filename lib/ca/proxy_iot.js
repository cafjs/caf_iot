...
exports.newInstance = function($, spec, cb) {
     ...
     * margin.
     *
     * @return {caf.bundleFac} A new bundle.
     *
     ...
     * callback).
     *
     * @return {caf.bundleDesc} An object with device
     ...
     * this method.
     *
     * @param {caf.bundleFac} bundle A bundle to execute.
     ...
     * @param {Array<caf.json>} args An array with method arguments.
     *
     * @memberof! module:caf_iot/ca/proxy_iot#
     * @alias iotApply
     */
    that.iotApply = function(method, args) {
        var bundle = that.newBundle();
