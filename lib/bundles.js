 ...
 * An example:
 *
 *        var bundle = newInstance({foo: [name, value], bar: [myArg]}, 2000)
 ...
 * and `caf.command`:
 *
 *          {after: mumber, method: string, args: Array.<caf.json>}
 *
 * @param {caf.bundleFac} bundle A bundle to transform.
 * @return {caf.bundle} A 'vanilla' object representation of the bundle.
 *
 * @memberof! module:caf_iot/bundles
 * @alias toObject
 *
 ...
 *
 *
 * @param {caf.bundle} bundleVanilla A 'vanilla' object representation of the
 * bundle. See `toObject`.
 * @param {caf.bundleDesc=} methods Optional object with method
 *  names and arguments.
 ...
 * @return {caf.bundleFac} A patched bundle.
 *
 * @memberof! module:caf_iot/bundles
 * @alias fromObject
 *
 ...
 *
 *  The type `caf.bundleDesc` is:
 *
 *         Object<string, Array.<string>>
 *
 * where the key is the name of the command, and the value an array of strings
 * with the argument names of this command (ignoring the last callback).
 *
 ...
 * time to allow bundle propagation. It defaults to `exports.MARGIN_IN_MSEC`
 *
 * @return {caf.bundleFac} A new bundle with no commands.
 *
 * @memberof! module:caf_iot/bundles
 * @alias newInstance
 */
exports.newInstance = function(methods, margin) {
    var commands = [];
     ...
     * @return {caf.bundleFac} This bundle initialized with commands.
     *
     * @memberof! module:caf_iot/bundles#
     * @alias __iot_parse__
     */
     ...
     *
     * @return {caf.bundleFac} A cloned bundle.
     *
     * @memberof! module:caf_iot/bundles#
     * @alias __iot_clone__
     */
     ...
     * @return {caf.bundleFac} This bundle fully initialized.
     *
     * @memberof! module:caf_iot/bundles#
