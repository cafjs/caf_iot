...
exports.newInstance = function(context, spec, secrets, cb) {
    ...
    /* {deviceId: Array.<{key: string, value: Object=}
     *
     *  where an undefined value means delete the key.
     */
    var changes = {};
    ...
    that.addCommandIoT = function(deviceId, command) {
        var deltas = changes[deviceId] || [];
    ...
    that.getCommandOutputs = function(deviceId) {
        var caViewToCloud =  iots[deviceId] && iots[deviceId].caView &&
            iots[deviceId].caView.toCloud;
         ...
         *
         */
        return caViewToCloud && caViewToCloud.values &&
            caViewToCloud.values.commands;
    };
    ...
    that.__ca_abort__ = function(cb0) {
        ...
        that__ca_resume__({logActions: toInitLog(Object.keys(iots))}, cb0);
    };
