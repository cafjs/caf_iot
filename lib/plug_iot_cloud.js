...
exports.newInstance = function($, spec, cb) {
    try {
        ...
        var tokenDir = spec.env.tokenDir || $.loader.__ca_firstModulePath__();
        ...
        var myId = $._.__ca_getName__();

        var cli = new caf_cli.Session(caURL, myId, {
            from: myId,
            token: token,
         ...
         *
         * @param {function(caf.msg)|null} handler A function of type
         * `function(caf.msg)` to process notifications. `null` deregisters
         * previous handlers.
         *
         * @memberof! module:caf_iot/plug_iot_cloud#
