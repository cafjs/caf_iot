...
const plug = exports.plug = require('./ca/plug_iot.js');
 ...
 *
 * @param {cbType} newCallback A default callback for the `init` method.
 *
 * @return {cbType} The old value for the callback.
 *
 * @memberof! module:caf_iot/main#
 * @alias setInitCallback
 */
exports.setInitCallback = function(newCallback) {
    const old = initCallback;
