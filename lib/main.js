...
var ca_iot = exports.ca_iot = require('./ca_iot.js');

/**
 * Mixin default CA methods to enable IoT device management.
 *
 * @param {Object} methods Application CA methods to be extended.
 *
 * @return {Object} A new object combining IoT and provided CA methods.
 *
 */
exports.mixinCA = function(methods) {
    return myUtils.cloneAndMixin(ca_iot.methods, methods);
};
